...
Item {
    ...
    MultiEffect {
        ...
        shadowVerticalOffset: 0 // 阴影向下偏移，增强悬浮感
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    // 颜色优先级：活动 > 有窗口 > 悬停 > 空闲
                    color: delegateRoot.active ? Colorscheme.primary : delegateRoot.hasWindows ? Colorscheme.on_surface : delegateRoot.isHovered ? Colorscheme.surface_variant : Colorscheme.surface_container_highest
