...
set -gx AVANTE_OPENAI_API_KEY "82098e807d03ba9ec6d6b2aef99e7b1d:NmMyNDQ3ODZmNTExOWEwNGEwNzg1NmZl"
set -gx ALIYUNPAN_CONFIG_DIR ~/.config/aliyunpan/config
set -gx SDCV_PAGER "less -R"
alias del='trash-put'
...
alias bili='BBDown --work-dir ~/Vedios/bilibili'
alias sdict='sdcv -n --color --utf8-output'
